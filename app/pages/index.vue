          ...
          <div class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-800">
            ...
            <div class="relative">
              <div class="inline-flex p-3 rounded-xl bg-gradient-to-br from-accent-500 to-accent-600 text-white shadow-lg group-hover:shadow-accent-500/25 transition-all duration-300">
                <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.967a1 1 0 00.95.69h4.173c.969 0 1.371 1.24.588 1.81l-3.377 2.455a1 1 0 00-.364 1.118l1.286 3.967c.3.921-.755 1.688-1.538 1.118l-3.377-2.454a1 1 0 00-1.175 0l-3.377 2.454c-.783.57-1.838-.197-1.538-1.118l1.286-3.967a1 1 0 00-.364-1.118L2.04 9.394c-.783-.57-.381-1.81.588-1.81h4.173a1 1 0 00.95-.69l1.286-3.967z" />
                </svg>
              </div>
              <h3 class="mt-6 text-2xl font-bold text-gray-900 dark:text-white">
                {{ t('home.features.aiOptimized.title') }}
              </h3>
              <p class="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                {{ t('home.features.aiOptimized.description') }}
              </p>
